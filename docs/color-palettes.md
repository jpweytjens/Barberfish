...
The compact two-row preview SVGs embedded in the README's Color palettes
section are generated by `uv run scripts/generate_palette_previews.py`,
which writes to `docs/img/palette-{zone,grade}-*.svg`.
