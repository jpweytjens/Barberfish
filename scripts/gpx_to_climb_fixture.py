...
def main():
    ...
    ap.add_argument("--object", default="ClimbPreviewFixture",
                    help="name of the emitted Kotlin object (default ClimbPreviewFixture)")
    ap.add_argument("--package", default="com.jpweytjens.barberfish.datatype.shared",
    ...
    rng = f"Km {args.range_km[0]:g}-{args.range_km[1]:g}" if args.range_km else "Full track"
    ...
    if args.doc:
        ...
        print(f'/** Route fixture for the climb overlay config preview. {rng} of "Reina":')
