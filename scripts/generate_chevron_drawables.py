...
# Chevron silhouette: a wide, shallow arrowhead in a 25 x 17 viewport, scaled
# down to 12 x 8 dp so a mark sits within the colored route line's width
# instead of overhanging it. Viewport and path stay 25 x 17; only the emitted
# dp size shrinks.
_PATH_DATA = (
