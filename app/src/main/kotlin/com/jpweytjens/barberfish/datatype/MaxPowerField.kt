...
class MaxPowerField(private val karooSystem: KarooSystemService) :
    BarberfishDataType("barberfish", "max-power") {

    companion object {
        private const val LABEL = "Max Power"
    ...
    override fun liveFlow(context: Context): Flow<FieldState> =
        combine(
                context.streamMaxPowerFieldConfig(),
            ...
            .flatMapLatest { (cfg, profile, zones) ->
                karooSystem.streamDataFlow(DataType.Type.MAX_POWER).map { state ->
