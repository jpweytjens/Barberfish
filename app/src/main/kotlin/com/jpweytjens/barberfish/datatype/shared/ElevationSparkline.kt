...
// decodeElevationPolyline and visvalingamWhyatt live in ElevationGeometry.kt so the
// climber map overlay (ClimbPolylines.kt) can reuse them. This file keeps the
// rendering, warping, ratcheting, and fixture logic.
