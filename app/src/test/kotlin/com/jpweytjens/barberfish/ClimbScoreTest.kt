...
class ClimbScoreTest {
    ...
    @Test fun score_of_1km_at_8pct_is_16() {
        assertEquals(16.0, pcsClimbScore(gradePct = 8.0, lengthM = 1000.0), 0.001)
    }

    @Test fun score_scales_with_length_and_grade_squared() {
        // 2 km at 6%: (3)^2 * 2 = 18
    ...
    @Test fun approach_tier_boundaries() {
