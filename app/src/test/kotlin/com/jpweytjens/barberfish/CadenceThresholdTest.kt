...
class CadenceThresholdTest {
    ...
    @Test
    fun target_disabled_returns_default() {
    ...
    @Test
    fun target_at_threshold_returns_zero_factor() {
    ...
    @Test
    fun target_above_threshold_returns_positive_factor() {
        val cfg =
            CadenceThresholdConfig(
    ...
    @Test
    fun target_below_threshold_returns_negative_factor() {
        val cfg =
            CadenceThresholdConfig(
                mode = ThresholdMode.TARGET,
                thresholdRpm = 90.0,
    ...
    @Test
    fun target_factor_clamped_to_minus_one() {
        val cfg =
            CadenceThresholdConfig(
                mode = ThresholdMode.TARGET,
                thresholdRpm = 90.0,
    ...
    @Test
    fun min_max_both_null_returns_default() {
        val cfg =
            CadenceThresholdConfig(
    ...
    @Test
    fun min_max_inside_safe_zone_returns_zero_outside_factor() {
        val cfg =
            CadenceThresholdConfig(
                mode = ThresholdMode.MIN_MAX,
                minRpm = 80.0,
    ...
    @Test
    fun min_max_below_min_returns_positive_outside_factor() {
        val cfg =
            CadenceThresholdConfig(
                mode = ThresholdMode.MIN_MAX,
                minRpm = 80.0,
    ...
    @Test
    fun min_max_above_max_returns_positive_outside_factor() {
        val cfg =
            CadenceThresholdConfig(
                mode = ThresholdMode.MIN_MAX,
                minRpm = 80.0,
