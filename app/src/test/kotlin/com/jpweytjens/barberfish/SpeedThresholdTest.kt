...
class SpeedThresholdTest {
    ...
    @Test
    fun helper_zero_threshold_returns_default() {
        assertEquals(FieldColor.Default, targetThresholdColor(25.0, 0.0, 10.0, 10.0))
    }

    @Test
    fun helper_negative_threshold_returns_default() {
    ...
    @Test
    fun helper_above_threshold_clamps_to_one() {
    ...
    @Test
    fun helper_below_threshold_clamps_to_minus_one() {
        val color = targetThresholdColor(20.0, 30.0, 10.0, 10.0) as FieldColor.Threshold
        assertEquals(-1f, color.factor, 0.001f)
    }

    @Test
    fun helper_asymmetric_ranges_pick_above_when_above() {
    ...
    @Test
    fun helper_asymmetric_ranges_pick_below_when_below() {
    ...
    @Test
    fun preview_fixed_disabled_shows_default() {
        val cfg =
            SpeedFieldConfig(
    ...
    @Test
    fun preview_fixed_enabled_produces_colored_transitions() {
        val cfg =
            SpeedFieldConfig(
                smoothing = SpeedSmoothingStream.S3,
                source = SpeedThresholdSource.FIXED,
    ...
    @Test
    fun preview_avg_total_uses_synthetic_threshold_without_warmup() {
    ...
    @Test
    fun preview_avg_moving_uses_synthetic_threshold_without_warmup() {
        val cfg =
            SpeedFieldConfig(
                smoothing = SpeedSmoothingStream.S3,
    ...
    @Test
    fun preview_propagates_background_color_mode() {
        val cfg =
            SpeedFieldConfig(
                smoothing = SpeedSmoothingStream.S3,
                source = SpeedThresholdSource.FIXED,
